---
title: PCT Section J Field Guide
theme: alpine
---
...
<div class="photo-grid is-featured">
  <figure>
    <img src="assets/images/section-j-waptus.jpg" alt="Waptus Lake basin on PCT Section J">
  ...
  <figure>
    <img src="assets/images/section-j-spectacle.jpg" alt="Spectacle Lake in the Alpine Lakes Wilderness">
  ...
  <figure>
    <img src="assets/images/section-j-kendall.jpg" alt="Rocky traverse near Kendall Katwalk">
...
```mermaid
flowchart TD
  A[Look at map before moving] --> B{Name next feature}
  B --> C{Is terrain steep, exposed, or wet?}
  C -->|Steep| D[Shorten stride and use poles]
  C -->|Exposed| E[Layer early and check weather]
  C -->|Wet| F[Slow crossings and protect feet]
  D --> G[Check body every hour]
  E --> G
  F --> G
  G --> H{Still on plan?}
  H -->|Yes| I[Continue to next feature]
  H -->|No| J[Cut side trip, camp lower, or exit]
```
...
<div class="photo-grid is-two">
  <figure>
    <img src="assets/images/section-j-waptus.jpg" alt="Waptus Lake shore and forested basin">
  ...
  <figure>
    <img src="assets/images/section-j-spectacle.jpg" alt="Spectacle Lake basin with alpine water">
...
```mermaid
flowchart LR
  A[Tent / sleeping area] --- B[Cooking and eating area]
  B --- C[Food storage]
  C --- A
```
...
<div class="photo-grid is-featured">
  <figure>
    <img src="assets/images/section-j-kendall.jpg" alt="Rocky alpine trail near Kendall Katwalk">
  ...
  <figure>
    <img src="assets/images/section-j-waptus.jpg" alt="Forested lake basin suitable for discussing campcraft">
  ...
  <figure>
    <img src="assets/images/section-j-spectacle.jpg" alt="High lake basin with alpine camp considerations">
